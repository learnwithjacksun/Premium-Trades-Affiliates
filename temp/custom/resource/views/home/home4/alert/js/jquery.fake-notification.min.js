    ...
    var c = a.extend(
      {
        ...
        Amount: [100, 2500],
        Content:
          "[Varible1] from [Varible2] has just placed an order for $[Amount].",
        Show: ["stable", 20, 100],
        Close: 5,
        Time: [0, 23],
        LocationTop: [true, "10%"],
    ...
    return this.each(function () {
      ...
      function A() {
        if (c.Show[0] == "stable") {
          ...
          var open =
            (Math.floor(Math.random() * (c.Show[2] - c.Show[1])) + c.Show[1]) *
            1000;
        }
        setTimeout(function () {
          J();
          ...
          var rand_heard_number =
            Math.floor(Math.random() * (c.Amount[0] - c.Amount[1])) +
            c.Amount[1];
          if (c.Content.indexOf("[Varible1]") + 1) {
            var content = c.Content.replace(
              "[Varible1]",
              c.Varible1[rand_heard_name]
            );
          } else {
            var content = c.Content.replace(
              "[Varible1]",
